...
class QNetwork:
    def __init__(self, hidden_size, learning_rate, item_num, state_size, pretrain, lam, name='DQNetwork'): # added lam hyperparameter
        ...
        with tf.variable_scope(self.name):
            ...
            # with item features
            self.output3= tf.contrib.layers.fully_connected(self.states_hidden, self.item_num,
                                                             activation_fn=None, scope="ce-logits")  # all ce logits
            # final logits
